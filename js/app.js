(() => {
  ...
  var D = (function () {
      ...
      return (
        ...
        (e.prototype.getStep = function (e) {
          return (e = I(this.xPct, this.xSteps, this.snap, e));
        }),
        ...
        (e.prototype.handleEntryPoint = function (e, t) {
          var s;
          if (
            !S((s = "min" === e ? 0 : "max" === e ? 100 : parseFloat(e))) ||
            !S(t[0])
          )
  ...
  function le(e) {
    ...
    e.format && !e.ariaFormat && (e.ariaFormat = e.format),
      Object.keys(s).forEach(function (n) {
        if (y(e[n]) || void 0 !== i[n]) s[n].t(t, y(e[n]) ? e[n] : i[n]);
        else if (s[n].r)
  ...
  function ce(e, t, s) {
    ...
    function D(e, t) {
      ...
      return t && A(s, t), e.appendChild(s), s;
    }
    function V(e, s) {
          ...
          n.addEventListener("keydown", function (e) {
            return (function (e, s) {
              ...
              if ((e.preventDefault(), p || u)) {
                ...
                if (null === y) return !1;
                !1 === y &&
                  (y = f.getDefaultStep(v[s], u, t.keyboardDefaultStep)),
                  (y *=
      ...
      return (
        ...
        0 === s
          ? A(n, t.cssClasses.handleLower)
          : s === t.handles - 1 && A(n, t.cssClasses.handleUpper),
        (i.handle = n),
        i
      );
    }
    ...
    function H() {
      j(),
        (o = n.map(q)),
        ie("update" + N.tooltips, function (e, s, i) {
    ...
    function G(e) {
      var t,
        s = (function (e) {
          if (e.mode === m.Range || e.mode === m.Steps) return f.xVal;
          if (e.mode === m.Count) {
            if (e.values < 2)
              throw new Error(
        ...
        s.forEach(function (t, n) {
          ...
          for (
            ...
            for (
              ...
              i[(h = l + d * w).toFixed(5)] = [f.fromStepping(h), 0];
            (v =
              s.indexOf(c) > -1 ? g.LargeValue : E ? g.SmallValue : g.NoValue),
              !n && a && c !== x && (v = 0),
    ...
    function R(e, s, i) {
      var n,
        ...
        o =
          (((n = {})[g.None] = ""),
          (n[g.NoValue] = t.cssClasses.valueNormal),
          (n[g.LargeValue] = t.cssClasses.valueLarge),
          (n[g.SmallValue] = t.cssClasses.valueSub),
          n),
        l =
          (((r = {})[g.None] = ""),
          (r[g.NoValue] = t.cssClasses.markerNormal),
          (r[g.LargeValue] = t.cssClasses.markerLarge),
          (r[g.SmallValue] = t.cssClasses.markerSub),
          r),
    ...
    function J(e, s) {
      s.handle && (L(s.handle, t.cssClasses.active), (C -= 1)),
        s.listeners.forEach(function (e) {
          k.removeEventListener(e[0], e[1]);
        }),
        0 === C &&
          (L(p, t.cssClasses.drag),
          ue(),
          e.cursor &&
      ...
      if (!s.handleNumbers.some(B)) {
        ...
        r.push.apply(r, a.concat(o, l)),
          e.cursor &&
            ...
            n.length > 1 && A(p, t.cssClasses.drag),
    ...
    function te(e) {
      ...
      !1 !== i &&
        (t.events.snap || x(p, t.cssClasses.tap, t.animationDuration),
        pe(i, s, !0, !0),
        ue(),
        re("slide", i, !0),
        re("update", i, !0),
    ...
    function pe(e, s, i, r, a, o) {
      return (
        a || (s = ae(v, e, s, i, r, !1, o)),
        !1 !== s &&
          ((function (e, s) {
            (v[e] = s), (h[e] = f.fromStepping(s));
            var i = "translate(" + oe(de(s, 0) - I + "%", "0") + ")";
    ...
    function fe(e) {
      if (r[e]) {
        var s = 0,
          i = 100;
        0 !== e && (s = v[e - 1]), e !== r.length - 1 && (i = v[e]);
        var n = i - s,
          a = "translate(" + oe(de(s, n) + "%", "0") + ")",
          o = "scale(" + oe(n / 100, "1") + ")";
    ...
    function me(e, s, i) {
      var n = T(e),
        r = void 0 === v[0];
      (s = void 0 === s || s),
        t.animate && !r && x(p, t.cssClasses.tap, t.animationDuration),
        S.forEach(function (e) {
          pe(e, he(n[e], e), !0, !1, i);
        });
      var a = 1 === S.length ? 0 : 1;
      if (r && f.hasNoSize() && ((i = !0), (v[0] = 0), S.length > 1)) {
        var o = 100 / (S.length - 1);
        S.forEach(function (e) {
          v[e] = e * o;
        });
      }
    ...
    A((l = p), t.cssClasses.target),
      0 === t.dir ? A(l, t.cssClasses.ltr) : A(l, t.cssClasses.rtl),
      0 === t.ort ? A(l, t.cssClasses.horizontal) : A(l, t.cssClasses.vertical),
      A(
        l,
      ...
      (function (e, s) {
        ...
        for (var a = 0; a < t.handles; a++)
          n.push(V(s, a)), (S[a] = a), r.push($(i, e[a + 1]));
      })(t.connect, i),
      (c = t.events).fixed ||
        n.forEach(function (e, t) {
      ...
      t.tooltips && H(),
      ne("update" + N.aria),
      ie("update" + N.aria, function (e, s, i, r, a) {
        S.forEach(function (e) {
          var s = n[e],
            r = ae(v, e, 0, !0, !0, !0),
            o = ae(v, e, 100, !0, !0, !0),
  ...
  function we(e, t, s) {
    ...
    t &&
      fe(e) &&
      ((n = (e.offsetWidth > 0 && ve(i.width) / e.offsetWidth) || 1),
      (r = (e.offsetHeight > 0 && ve(i.height) / e.offsetHeight) || 1));
    var a = (pe(e) ? ue(e) : window).visualViewport,
      o = !ye() && s,
  ...
  function Te(e) {
    return we(Ee(e)).left + Se(e).scrollLeft;
  }
  function Ce(e) {
      ...
      a =
        ...
        (function (e) {
          var t = e.getBoundingClientRect(),
            s = ve(t.width) / e.offsetWidth || 1,
            i = ve(t.height) / e.offsetHeight || 1;
          return 1 !== s || 1 !== i;
        })(t),
      o = Ee(t),
      l = we(e, a, s),
        ...
        (("body" !== xe(t) || Ae(o)) &&
          (c =
            (i = t) !== ue(i) && fe(i)
              ...
              : Se(i)),
        fe(t)
          ? (((d = we(t, !0)).x += t.clientLeft), (d.y += t.clientTop))
          : o && (d.x = Te(o))),
      {
  ...
  function Pe(e) {
    return "html" === xe(e)
      ? e
      : e.assignedSlot || e.parentNode || (he(e) ? e.host : null) || Ee(e);
  }
  function Me(e) {
  ...
  function ke(e, t) {
    ...
    var i = Me(e),
      ...
      r = ue(i),
      a = n ? [r].concat(r.visualViewport || [], Ae(i) ? i : []) : i,
      o = t.concat(a);
    return n ? o : o.concat(ke(Pe(a)));
  }
  function _e(e) {
    return ["table", "td", "th"].indexOf(xe(e)) >= 0;
  }
  function Ie(e) {
    return fe(e) && "fixed" !== Ce(e).position ? e.offsetParent : null;
  }
  function De(e) {
    for (var t = ue(e), s = Ie(e); s && _e(s) && "static" === Ce(s).position; )
      s = Ie(s);
    return s &&
      ("html" === xe(s) || ("body" === xe(s) && "static" === Ce(s).position))
      ? t
      : s ||
          (function (e) {
            var t = /firefox/i.test(be());
            if (/Trident/i.test(be()) && fe(e) && "fixed" === Ce(e).position)
              return null;
            var s = Pe(e);
            for (
              he(s) && (s = s.host);
              fe(s) && ["html", "body"].indexOf(xe(s)) < 0;
  ...
  var Ve = "top",
    ...
    Re = "popper",
    We = "reference",
    Ue = Be.reduce(function (e, t) {
      return e.concat([t + "-" + je, t + "-" + He]);
    }, []),
    Ye = [].concat(Be, [ze]).reduce(function (e, t) {
      return e.concat([t, t + "-" + je, t + "-" + He]);
    }, []),
    Xe = [
      "beforeRead",
      "read",
        ...
        d = {
          ...
          forceUpdate: function () {
            if (!c) {
              ...
              if (Ze(t, s)) {
                (o.rects = {
                  reference: Le(t, De(s), "fixed" === o.options.strategy),
                  popper: Oe(s),
                }),
                  (o.reset = !1),
  ...
  function at(e) {
    ...
    var C,
      A = Object.assign({ position: o }, c && rt),
      L =
        !0 === d
          ? (function (e, t) {
              var s = e.x,
              ...
              return { x: ve(s * n) / n || 0, y: ve(i * n) / n || 0 };
            })({ x: f, y: m }, ue(s))
          : { x: f, y: m };
    return (
      (f = L.x),
  ...
  const lt = {
    ...
    fn: function (e) {
      var t = e.state,
        ...
        n = s.offset,
        r = void 0 === n ? [0, 0] : n,
        a = Ye.reduce(function (e, s) {
          return (
            (e[s] = (function (e, t, s) {
              var i = tt(e),
                n = [qe, Ve].indexOf(i) >= 0 ? -1 : 1,
                r =
                  "function" == typeof s
              ...
              return (
                (a = a || 0),
                (o = (o || 0) * n),
                [qe, Ne].indexOf(i) >= 0 ? { x: o, y: a } : { x: a, y: o }
              );
            })(s, t.rects, r)),
            e
          );
    ...
    return t === Ge
      ? ht(
          (function (e, t) {
            ...
            return { width: r, height: a, x: o + Te(e), y: l };
          })(e, s),
        )
      : pe(t)
        ? (function (e, t) {
            var s = we(e, !1, "fixed" === t);
            return (
        ...
        : ht(
            (function (e) {
              var t,
                ...
                l = -i.scrollTop;
              return (
                "rtl" === Ce(n || s).direction &&
                  (o += me(s.clientWidth, n ? n.clientWidth : 0) - r),
    ...
    var n =
        "clippingParents" === t
          ? (function (e) {
              var t = ke(Pe(e)),
                s =
                  ["absolute", "fixed"].indexOf(Ce(e).position) >= 0 && fe(e)
                    ? De(e)
                    : e;
              return pe(s)
                ? t.filter(function (e) {
                    return pe(e) && ft(e, s) && "body" !== xe(e);
                  })
                : [];
            })(e)
          : [].concat(t),
      ...
      o = r.reduce(
        function (t, s) {
          var n = mt(e, s, i);
          return (
            (t.top = me(n.top, t.top)),
            (t.right = ge(n.right, t.right)),
            (t.bottom = ge(n.bottom, t.bottom)),
            (t.left = me(n.left, t.left)),
            t
          );
        },
        mt(e, a, i),
  ...
  function yt(e, t) {
    ...
    var s = t,
      ...
      m = s.padding,
      g = void 0 === m ? 0 : m,
      v = vt("number" != typeof g ? g : bt(g, Be)),
      b = p === Re ? We : Re,
      y = e.rects.popper,
      w = e.elements[h ? b : p],
      S = gt(pe(w) ? w : w.contextElement || Ee(e.elements.popper), l, d, a),
      x = we(e.elements.reference),
      E = nt({ reference: x, element: y, strategy: "absolute", placement: n }),
      T = ht(Object.assign({}, y, E)),
      C = p === Re ? T : x,
      A = {
    ...
    if (p === Re && L) {
      ...
      Object.keys(A).forEach(function (e) {
        var t = [Ne, $e].indexOf(e) >= 0 ? 1 : -1,
          s = [Ve, $e].indexOf(e) >= 0 ? "y" : "x";
        A[e] += O[s] * t;
      });
    }
    return A;
  ...
  const St = {
    ...
    fn: function (e) {
      var t = e.state,
        ...
        h = s.tetherOffset,
        m = void 0 === h ? 0 : h,
        g = yt(t, { boundary: l, rootBoundary: c, padding: u, altBoundary: d }),
        v = tt(t.placement),
        b = st(t.placement),
        y = !b,
        w = it(v),
      ...
      if (x) {
        if (r) {
          var P,
            ...
            F = j[k],
            G = wt(0, E[_], B[_]),
            R = y ? E[_] / 2 - $ - G - H - A.mainAxis : N - G - H - A.mainAxis,
            W = y ? -E[_] / 2 + $ + G + F + A.mainAxis : q + G + F + A.mainAxis,
            U = t.elements.arrow && De(t.elements.arrow),
            Y = U ? ("y" === w ? U.clientTop || 0 : U.clientLeft || 0) : 0,
            X = null != (P = null == L ? void 0 : L[w]) ? P : 0,
            K = I + W - X,
            Q = wt(f ? ge(D, I + R - X - Y) : D, I, f ? me(V, K) : V);
          (x[w] = Q), (O[w] = Q - I);
        }
        if (o) {
          var Z,
            ...
            ie = te + g[J],
            ne = te - g[ee],
            re = -1 !== [Ve, qe].indexOf(v),
            ae = null != (Z = null == L ? void 0 : L[S]) ? Z : 0,
  ...
  const xt = {
    ...
    fn: function (e) {
      var t,
        ...
        o = tt(s.placement),
        l = it(o),
        c = [qe, Ne].indexOf(o) >= 0 ? "height" : "width";
      if (r && a) {
        var d = (function (e, t) {
            return vt(
              "number" !=
  ...
  function Tt(e) {
    return [Ve, Ne, $e, qe].some(function (t) {
      return e[t] >= 0;
    });
  }
  var Ct = Je({
            ...
            return (
              r &&
                c.forEach(function (e) {
                  e.addEventListener("scroll", s.update, et);
                }),
              o && l.addEventListener("resize", s.update, et),
              function () {
                r &&
                  c.forEach(function (e) {
                    e.removeEventListener("scroll", s.update, et);
                  }),
                  o && l.removeEventListener("resize", s.update, et);
              }
            );
          },
          data: {},
        ...
        xt,
        {
          ...
          fn: function (e) {
            var t = e.state,
              ...
              a = yt(t, { elementContext: "reference" }),
  ...
  function Rt(e) {
    return Ht(e)
      ...
      : (function (e) {
        ...
        : Array.isArray(e)
          ? e
          : zt(document.querySelectorAll(e));
  }
  function Wt(e, t) {
    e.forEach(function (e) {
  ...
  function Jt() {
    Qt.isTouch ||
      ((Qt.isTouch = !0),
      window.performance && document.addEventListener("mousemove", es));
  }
  function es() {
    var e = performance.now();
    e - Zt < 20 &&
      ((Qt.isTouch = !1), document.removeEventListener("mousemove", es)),
      (Zt = e);
  }
  function ts() {
  ...
  function as(e) {
    var t = (e.plugins || []).reduce(function (t, s) {
      var i,
        n = s.name,
        r = s.defaultValue;
      n && (t[n] = void 0 !== e[n] ? e[n] : null != (i = ns[n]) ? i : r);
      return t;
    }, {});
  ...
  function os(e, t) {
    var s = Object.assign(
      {},
      t,
      { content: Dt(t.content, [e]) },
      t.ignoreAttributes
        ? {}
        : (function (e, t) {
            return (
              t ? Object.keys(as(Object.assign({}, ns, { plugins: t }))) : rs
            ).reduce(function (t, s) {
    ...
    return (
      (s.aria = Object.assign({}, ns.aria, s.aria)),
      (s.aria = {
  ...
  function ds(e) {
    ...
    return (
      !0 === e
        ? (t.className = Ot)
        : ((t.className = Pt), Ht(e) ? t.appendChild(e) : cs(t, e)),
      t
    );
  }
  function us(e, t) {
    Ht(t.content)
      ? (cs(e, ""), e.appendChild(t.content))
      : "function" != typeof t.content &&
        (t.allowHTML ? cs(e, t.content) : (e.textContent = t.content));
  }
  function ps(e) {
    ...
    return {
      ...
      arrow: s.find(function (e) {
        return e.classList.contains(Ot) || e.classList.contains(Pt);
      }),
    ...
    function n(s, i) {
      ...
      i.theme
        ...
        i.arrow
          ? o
            ? s.arrow !== i.arrow &&
              (r.removeChild(o), r.appendChild(ds(i.arrow)))
            : r.appendChild(ds(i.arrow))
          : o && r.removeChild(o);
    }
    return (
      (i.className = At),
  ...
  function vs(e, t) {
    var s,
      ...
      l,
      c,
      d = os(e, Object.assign({}, ns, as(Bt(t)))),
      u = !1,
      p = !1,
      f = !1,
      h = !1,
      m = [],
      g = Vt(U, d.interactiveDebounce),
      v = hs++,
      ...
      y = {
        ...
        setProps: function (t) {
          ...
          var s = y.props,
            i = os(e, Object.assign({}, s, Bt(t), { ignoreAttributes: !0 }));
          (y.props = i),
            G(),
            s.interactiveDebounce !== i.interactiveDebounce &&
              ($(), (g = Vt(U, i.interactiveDebounce)));
        ...
        show: function () {
          ...
          var e = y.state.isVisible,
            ...
            n = _t(y.props.duration, 0, ns.duration);
          if (e || t || s || i) return;
          ...
          (o = function () {
            ...
            (function () {
              var e,
                ...
                s = O();
              e =
                (y.props.interactive && t === kt) || "parent" === t
                  ? s.parentNode
                  : Dt(t, [s]);
        ...
        hide: function () {
          ...
          var e = !y.state.isVisible,
            t = y.state.isDestroyed,
            s = !y.state.isEnabled,
            i = _t(y.props.duration, 1, ns.duration);
          if (e || t || s) return;
          ...
          if (($(), j(), _(!0), L())) {
            var n = M(),
              r = n.box,
              a = n.content;
            y.props.animation && (Wt([r, a], i), Ut([r, a], "hidden"));
          }
          D(),
            V(),
            y.props.animation
        ...
        hideWithInteractivity: function (e) {
          0;
          P().addEventListener("mousemove", g), Nt(ms, g), g(e);
        },
        enable: function () {
          y.state.isEnabled = !0;
        },
    ...
    function k(e) {
      return (y.state.isMounted && !y.state.isVisible) ||
        ...
        (r && "focus" === r.type)
        ? 0
        : _t(y.props.delay, e ? 0 : 1, ns.delay);
    }
    function _(e) {
      void 0 === e && (e = !1),
    ...
    function B() {
      ...
      e.addEventListener("mousedown", N, !0),
        e.addEventListener("touchend", N, Mt),
        e.addEventListener("touchstart", z, Mt),
        e.addEventListener("touchmove", q, Mt);
    }
    function j() {
      var e = P();
      e.removeEventListener("mousedown", N, !0),
        e.removeEventListener("touchend", N, Mt),
        e.removeEventListener("touchstart", z, Mt),
        e.removeEventListener("touchmove", q, Mt);
    }
    function H(e, t) {
      var s = M().box;
      function i(e) {
        e.target === s && (Xt(s, "remove", i), t());
      }
      if (0 === e) return t();
      Xt(s, "remove", a), Xt(s, "add", i), (a = i);
    }
    function F(t, s, i) {
      void 0 === i && (i = !1),
        $t(y.props.triggerTarget || e).forEach(function (e) {
    ...
    function K(e) {
      return !!Qt.isTouch && A() !== e.type.indexOf("touch") >= 0;
    }
    function Q() {
      Z();
      var t = y.props,
    ...
    function J() {
      return zt(S.querySelectorAll("[data-tippy-root]"));
    }
    function ee(e) {
  ...
  function bs(e, t) {
    void 0 === t && (t = {});
    var s = ns.plugins.concat(t.plugins || []);
    document.addEventListener("touchstart", Jt, Mt),
      window.addEventListener("blur", ts);
    ...
    updateSize: function () {
      ...
      (t =
        ...
        (0 === t && e.isHorizontal()) ||
          ...
          ((t =
            t -
            parseInt(Vs(i, "padding-left") || 0, 10) -
            parseInt(Vs(i, "padding-right") || 0, 10)),
          (s =
            s -
            parseInt(Vs(i, "padding-top") || 0, 10) -
            parseInt(Vs(i, "padding-bottom") || 0, 10)),
          Number.isNaN(t) && (t = 0),
          Number.isNaN(s) && (s = 0),
          Object.assign(e, {
            width: t,
      ...
      transition: {
        ...
        transitionStart: function (e, t) {
          ...
          i.cssMode ||
            ...
            Qs({ swiper: s, runCallbacks: e, direction: t, step: "Start" }));
        },
        transitionEnd: function (e, t) {
          ...
          (s.animating = !1),
            i.cssMode ||
              (s.setTransition(0),
              Qs({ swiper: s, runCallbacks: e, direction: t, step: "End" }));
        },
      },
      slide: Zs,
      loop: Js,
  ...
  class mi {
    ...
    getSlideIndex(e) {
      const { slidesEl: t, params: s } = this,
        i = $s(_s(t, `.${s.slideClass}, swiper-slide`)[0]);
      return $s(e) - i;
    }
    ...
    mount(e) {
      ...
      return (
        ...
        Object.assign(t, {
          ...
          mounted: !0,
          rtl: "rtl" === s.dir.toLowerCase() || "rtl" === Vs(s, "direction"),
          rtlTranslate:
            "horizontal" === t.params.direction &&
            ("rtl" === s.dir.toLowerCase() || "rtl" === Vs(s, "direction")),
          wrongRTL: "-webkit-box" === Vs(n, "display"),
        }),
        !0
      );
    }
  ...
  function yi(e) {
    ...
    function u(e) {
      ...
      if (!s) return;
      e.preventDefault();
      const i = $s(s) * t.params.slidesPerGroup;
      if (t.params.loop) {
              ...
              on: {
                ...
                slideChange: function (e) {
                  document.querySelector(
                    ...
                    e.realIndex + 1 < 10 ? `0${e.realIndex + 1}` : e.realIndex;
                },
              },
            }),
  ...
  const Ci = document.querySelectorAll(".sub-menu-catalog__block");
  Ci.length &&
    Ci.forEach((e) => {
